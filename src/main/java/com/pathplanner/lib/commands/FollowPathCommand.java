...
public class FollowPathCommand extends Command {
    ...
    @Getter private final BiConsumer<ChassisSpeeds, DriveFeedforwards> output;
    ...
    public Time timeUntilDone() {
        return Seconds.of(trajectory.getTotalTimeSeconds()).minus(Seconds.of(timer.get()));
    }

    public FollowPathCommand withOutput(BiConsumer<ChassisSpeeds, DriveFeedforwards> output) {
        ...
        return new FollowPathCommand(
                ...
                robotConfig,
                shouldFlipPath,
                requirements.toArray(new Subsystem[requirements.size()]));
    }
}
