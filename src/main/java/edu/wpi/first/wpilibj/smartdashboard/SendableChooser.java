...
public class SendableChooser<V> implements Sendable, AutoCloseable {
    ...
    /**
     * Adds the given object to the list of options and marks it as the default. Functionally, this
     * is very close to {@link #addOption(String, Object)} except that it will use this as the
     * default option if none other is explicitly selected.
     *
     * @param name the name of the option
     * @param object the option
     */
