...
public class SwerveDriveSubsystem extends TunerSwerveDrivetrain implements Subsystem {
    ...
    Time startTimeCharacterizing = Milliseconds.of(System.currentTimeMillis());
    ...
    public void resetCharacterizationData() {
        characterizationData = new FeedForwardCharacterizationData();
        startTimeCharacterizing = Milliseconds.of(System.currentTimeMillis());
    }
    ...
    public Time getTimeSinceStartCharacterizing() {
        return Milliseconds.of(System.currentTimeMillis()).minus(startTimeCharacterizing);
    }

    public void printCharacterizationData() {
