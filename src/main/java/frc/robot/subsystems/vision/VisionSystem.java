...
public class VisionSystem extends HocSubsystem {
    ...
    public VisionSystem(VisionConfig config) {
        ...
        fl_camera = new PhotonCameraPlus("fl_camera", config.getFLRobotToCamera(), swerve, swerve);
        fr_camera = new PhotonCameraPlus("fr_camera", config.getFRRobotToCamera(), swerve, swerve);
        rl_camera = new PhotonCameraPlus("rl_camera", config.getRLRobotToCamera(), swerve, swerve);
        rr_camera = new PhotonCameraPlus("rr_camera", config.getRRRobotToCamera(), swerve, swerve);
