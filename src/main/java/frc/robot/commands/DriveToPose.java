...
public class DriveToPose<T extends Subsystem & RobotPoseSupplier & DriveSpeedsConsumer & FieldRelativeSpeedsSupplier & MaxKinematicsSupplier>
                extends Command {
        private static final LoggedTunableNumber drivekP = new LoggedTunableNumber("DriveToPose/DrivekP");
        private static final LoggedTunableNumber driveClosekP = new LoggedTunableNumber("DriveToPose/DriveClosekP");
        private static final LoggedTunableNumber drivekPDistance = new LoggedTunableNumber(
                        "DriveToPose/DrivekPDistance");
        private static final LoggedTunableNumber driveClosekPDistance = new LoggedTunableNumber(
                        "DriveToPose/DriveClosekPDistance");
        ...
        public void execute() {
                ...
                var percentNormalVsClose = (MathUtil.clamp(driveErrorAbs, driveClosekPDistance.get(),
                                drivekPDistance.get())
                                - driveClosekPDistance.get())
                                / (drivekPDistance.get() - driveClosekPDistance.get());

                var updatedDriveKp = drivekP.get() * percentNormalVsClose
                ...
                var controllerSetpointTranslation = driveController.getSetpoint().equals(driveController.getGoal())
                                && !atGoal()
